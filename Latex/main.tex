...
\newcommand{\versuch}{Polarisation} % Name des Versuchs
...
\newcommand{\durchgefuehrt}{03.07.2017}      % Datum, an dem der Versuch
                                           % durchgeführt wurde
...
\input{./chap/chapter0.tex}
\chapter{Aufgabe 1: Untersuchung der Polarisationsarten}
\input{./chap/chapter1.tex} %\cleardoublepage
\chapter{Aufgabe 2: Ermittelung der Brechzahldifferenzen}
\input{./chap/chapter2.tex}
\chapter{Aufgabe 3: Farbaenderungen bei Glimmerplaettchen und Klebefilmbildchen}
\input{./chap/chapter3.tex}
\chapter{Aufgabe 4: Belastungsabhaengige Doppelbrechung bei Plexiglas}
